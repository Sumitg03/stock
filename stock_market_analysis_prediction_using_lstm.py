...
Original file is located at
    https://colab.research.google.com/drive/1i7AJ71Rgsfw5DlApQUCRb2Sebd44o7Aw
...
AAPL[['Adj Close', 'MA for 20 days', 'MA for 30 days', 'MA for 70 days']].plot(ax=axes[0,0])
axes[0,0].set_title('APPLE')

GOOG[['Adj Close', 'MA for 20 days', 'MA for 30 days', 'MA for 70 days']].plot(ax=axes[0,1])
axes[0,1].set_title('GOOGLE')

MSFT[['Adj Close', 'MA for 20 days', 'MA for 30 days', 'MA for 70 days']].plot(ax=axes[1,0])
axes[1,0].set_title('MICROSOFT')

AMZN[['Adj Close', 'MA for 20 days', 'MA for 30 days', 'MA for 70 days']].plot(ax=axes[1,1])
